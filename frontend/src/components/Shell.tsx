...
import {LayoutDashboard,CalendarRange,GraduationCap,FlaskConical,Waypoints,ChartNoAxesCombined,Building2,Users,Boxes,BookOpen,SlidersHorizontal,History,Search,Bell,PanelLeftClose,PanelLeft,LogOut,Settings,ChevronRight,UserCog} from "lucide-react";
...
export const NAV=[
 {group:"OPERATE",path:"overview",label:"Command Center",icon:LayoutDashboard,roles:["RTE"]},{group:"OPERATE",path:"timetable",label:"Timetable Studio",icon:CalendarRange,roles:["RTE","SSD"]},{group:"OPERATE",path:"exams",label:"Examinations",icon:GraduationCap,roles:["RTE","SSD"]},
 {group:"INTELLIGENCE",path:"optimization",label:"Optimization Lab",icon:FlaskConical,roles:["RTE"]},{group:"INTELLIGENCE",path:"whatif",label:"What-If Simulator",icon:Waypoints,roles:["RTE"]},{group:"INTELLIGENCE",path:"analytics",label:"Analytics",icon:ChartNoAxesCombined,roles:["RTE"]},
 {group:"MANAGE",path:"rooms",label:"Rooms & Resources",icon:Building2,roles:["RTE","SSD"]},{group:"MANAGE",path:"faculty",label:"Faculty Intelligence",icon:Users,roles:["RTE"]},{group:"MANAGE",path:"cohorts",label:"Cohort Flow",icon:Waypoints,roles:["RTE"]},{group:"MANAGE",path:"modules",label:"Modules",icon:Boxes,roles:["RTE"]},{group:"MANAGE",path:"programmes",label:"Programmes",icon:BookOpen,roles:["RTE"]},
 {group:"ADMINISTRATION",path:"student-messages",label:"Student Messaging",icon:Bell,roles:["RTE"]},{group:"ADMINISTRATION",path:"students",label:"Students",icon:GraduationCap,roles:["RTE"]},{group:"ADMINISTRATION",path:"accounts",label:"Accounts",icon:UserCog,roles:["SuperAdmin"]},
 {group:"SYSTEM",path:"rules",label:"Scheduling Rules",icon:SlidersHorizontal,roles:["RTE"]},{group:"SYSTEM",path:"notifications",label:"Communications",icon:Bell,roles:["RTE"]},{group:"SYSTEM",path:"audit",label:"Change Log",icon:History,roles:["SuperAdmin"]},{group:"SYSTEM",path:"settings",label:"Settings",icon:Settings,roles:["RTE"]}
];
