...
type ContextValue={selectedContext:Record<string,unknown>;setSelectedContext:(v:Record<string,unknown>)=>void;user:User|null;workspace:Workspace|null;loading:boolean;error:string;refresh:()=>Promise<void>;login:(email:string,password:string)=>Promise<void>;logout:()=>void;dark:boolean;toggleDark:()=>void;collapsed:boolean;setCollapsed:(v:boolean)=>void;palette:boolean;setPalette:(v:boolean)=>void;assistant:Record<string,unknown>|null;setAssistant:(v:Record<string,unknown>|null)=>void;notify:(text:string,tone?:string)=>void;toasts:Toast[];dismiss:(id:number)=>void;can:(...roles:string[])=>boolean};
