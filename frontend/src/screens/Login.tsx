...
export default function Login(){
 ...
 return <div className="login">
  ...
  <section className="login-form"><div className="login-form-inner"><span className="eyebrow">YOUR ACADEMIC WORKSPACE</span><h1>Welcome to NEXUS.</h1><p>Sign in to your college planning workspace.</p>
   ...
   <div className="demo-login"><ShieldCheck size={18}/><div><strong>Role-managed access</strong><p>SuperAdmins manage accounts. RTE administrators manage the timetable; SSD access is read-only.</p></div></div>
